  ...
  return (
    <section className="bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <p className="text-lg text-gray-700 mb-4 text-center">
        Hello! I am Umm e Aiman, a CS student with a love for creating dynamic and user-friendly web applications. I thrive in collaborative environments where I can learn and grow.
      </p>
      <p className="text-lg text-gray-700 mb-4 text-center">
      ...
      <p className="text-lg text-gray-700 mb-8 text-center">
        When I am not coding, you can find me reading books. I am always excited to connect with like-minded individuals, so feel free to reach out!
      </p>
